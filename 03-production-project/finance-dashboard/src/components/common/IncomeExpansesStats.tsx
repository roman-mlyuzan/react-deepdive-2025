...
function IncomeExpansesStats({ transactions }: IncomeExpansesStats) {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
      <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-all duration-100 hover:-translate-y-1 animate-fade-in">
      ...
      <div
        className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-all duration-100 hover:-translate-y-1 animate-fade-in"
